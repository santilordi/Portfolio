        ...
        <header className="left-panel">
            <div>
                ...
                <ul className="social-links">
                    <li>
                        <a href="https://github.com/santilordi" target="_blank" rel="noreferrer" aria-label="GitHub">
                    ...
                    <li>
                        <a href="https://www.linkedin.com/in/santiago-lordi/" target="_blank" rel="noreferrer" aria-label="LinkedIn">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
                    ...
                    <li>
                        <a href="mailto:santilordi569@gmail.com" target="_blank" rel="noreferrer" aria-label="Email">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
